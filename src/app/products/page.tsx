...
// import j6 from "/public/living.jpg";
// import j7 from "/public/living.jpg";
// import j8 from "/public/living.jpg";
// import j9 from "/public/living.jpg";
// import j27 from "/public/living.jpg";
// import j11 from "/public/living.jpg";
// import j18 from "/public/living.jpg";
// import j19 from "/public/living.jpg";
// import j14 from "/public/living.jpg";
// import j15 from "/public/living.jpg";
// import j16 from "/public/living.jpg";
// import j17 from "/public/living.jpg";

// const products = [
//   { id: 1, title: "Product 1", description: "A stylish modern sofa.", price: "$29.99", image: j6 },
//   { id: 2, title: "Product 2", description: "A classic and comfortable sofa", price: "$39.99", image: j7 },
//   { id: 3, title: "Product 3", description: "Elegant dining chair.", price: "$49.99", image: j8 },
//   { id: 4, title: "Product 4", description: "Ergonomic office chair.", price: "$59.99", image: j9 },
//   { id: 5, title: "Product 5", description: "Stylish coffee table.", price: "$59.99", image: j27 },
//   { id: 6, title: "Product 6", description: "Large dining table.", price: "$59.99", image: j11 },
//   { id: 7, title: "Product 7", description: "Luxurious king-size bed.", price: "$59.99", image: j18 },
//   { id: 8, title: "Product 8", description: "Cozy queen-size bed.", price: "$59.99", image: j19 },
//   { id: 9, title: "Product 9", description: "Cozy queen-size bed.", price: "$59.99", image: j14 },
//   { id: 10, title: "Product 10", description: "Cozy queen-size bed.", price: "$59.99", image: j15 },
//   { id: 10, title: "Product 11", description: "Cozy queen-size bed.", price: "$59.99", image: j16 },
//   { id: 10, title: "Product 12", description: "Cozy queen-size bed.", price: "$59.99", image: j17 },
//   ];
...
//             />
//             <div className="bg-teal-700  text-black p-4">
...
//               <button className="w-full bg-teal-500 text-black outline outline-2 outline-offset-2 px-4 py-2 mt-2 rounded-lg transition duration-300 hover:bg-slate-600 hover:shadow-xl hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 active:scale-95 active:ring-0 hover:shadow-slate-700/50">
//                 Add to Cart
//               </button>
//             </div>
//           </div>
